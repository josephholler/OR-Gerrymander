...
When the fragment is inside of its district, the chRatio is the Cdiff of the district.  
When the fragment is outside of its district (in the convex hull area), the chRatio is the Cdiff of the convex hull's district.
...
# will need the cDiff of the convex hull polygon as well
...
ch_frags <- ch_frags |> 
  ...
  mutate(minorRatio = awMinor / awTot,
         chRatio = case_when(
           DISTRICT == chDISTRICT ~ chDiff / 100,
           DISTRICT != chDISTRICT ~ ch_hull_Diff / 100,
           .default = 0),
         gerry = case_when(
           chRatio > 0 & minorRatio - chRatio > 0 & DISTRICT == chDISTRICT ~ (minorRatio - chRatio) * awTot,
           chRatio < 0 & minorRatio + chRatio > 0 & DISTRICT != chDISTRICT ~ (chRatio + minorRatio) * awTot,
           .default = 0
         ),
